...
The following describes the typings for custom meta definitions - an array of those in JSON format is expected and merged with the defined defaults.

Those definitions wont be visible in the settings - to disable, they have to be removed.
```typescript
/**
